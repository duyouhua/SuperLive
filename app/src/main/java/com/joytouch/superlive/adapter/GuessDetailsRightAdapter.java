 ...
 */
public class GuessDetailsRightAdapter extends AppBaseAdapter<GuessDetail> {

    public GuessDetailsRightAdapter(List<GuessDetail> list, Context context) {
        super(list, context);
    }
    ...
    public View createView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = inflater.inflate(R.layout.item_guess_detail_right,null);
