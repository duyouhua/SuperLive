 ...
 */
public class mylottGuessDetailsRightAdapter extends AppBaseAdapter<guess_item> {


    private final String s;

    public mylottGuessDetailsRightAdapter(List<guess_item> list,Context context, String s) {
        super(list, context);
        this.s=s;
    }
    ...
    public View createView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = inflater.inflate(R.layout.itemmy_guess_detail_right,null);
