 ...
 */
public class MyGuessAdapter extends BaseExpandableListAdapter {
    private List<MyGuess> myGuesses;
    private Context context;

    public MyGuessAdapter(List<MyGuess> myGuesses, Context context) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_myguess_bottom,null);
