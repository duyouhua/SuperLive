 ...
 */
public class powerfulRankAdapter extends AppBaseAdapter<rank_item> {
    private List<rank_item> ranks;
    public powerfulRankAdapter(List<rank_item> list, Context context) {
        super(list, context);
        this.ranks = list;
    }
    ...
    public View createView(int position, View convertView, ViewGroup parent) {
        ...
        ImageLoader.getInstance().displayImage(Preference.img_url + "200x200/" + info.image, holder.iv_icon, ImageLoaderOption.optionsHeader);
