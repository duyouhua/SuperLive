...
//    private String suffixText = "%";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //TODO calculate inner circle_lvse height and then position bottom text at the bottom (3/4)
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(getInnerBottomText())) {
            innerBottomTextPaint.setTextSize(innerBottomTextSize);
            float bottomTextBaseline = getHeight() - innerBottomTextHeight - (textPaint.descent() + textPaint.ascent()) / 32;
