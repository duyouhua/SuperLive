package com.joytouch.superlive.widget.expandMenuView;
...
public class ExpandMenuView extends LinearLayout implements OnDismissListener {
	...
	public void setValue(ArrayList<String> titles, ArrayList<View> selectionViews) {
		...
		for (int i = 0; i < selectionViews.size(); i++) {
			...
			line.setBackgroundResource(R.color.line_code);
			...
			popRootLayout.setBackgroundColor(mContext.getResources().getColor(R.color.transparent_background));
	...
	private void startAnimation() {
		...
		if (popupWindow == null) {
			...
			popupWindow.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.transparent_background)));
		}
