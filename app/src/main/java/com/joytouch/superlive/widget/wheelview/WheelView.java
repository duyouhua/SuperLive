package com.joytouch.superlive.widget.wheelview;
...
public class WheelView extends View {
    ...
    /** 非当前条目的文字颜色 */
    private static final int ITEMS_TEXT_COLOR = 0xFFb1b1b1;

    /** 顶部和底部的阴影颜色 */
    //private static final int[] SHADOWS_COLORS = new int[] { 0xFF5436EE, 0x0012CEAE, 0x0012CEAE };
    private static final int[] SHADOWS_COLORS = new int[] { 0xFFffffff, 0x50ffffff, 0x00ffffff };
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (itemsLayout == null || itemsLayout.getWidth() > widthItems) {
            ...
            itemsLayout = new StaticLayout(buildText(isScrollingPerformed), itemsPaint, widthItems,
                    widthLabel > 0 ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_CENTER, 1f,
