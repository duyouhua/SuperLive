...
public class SwitchButton extends View {
    ...
    private void initBitmap() {
        slideButtonBG = BitmapFactory.decodeResource(getResources(), R.drawable.livelist_lottery);
        switchBG = BitmapFactory.decodeResource(getResources(), R.drawable.cicrl_main);
    }
